...
@EnableSwagger2
public class DemnitarServiceApplication extends WebMvcConfigurerAdapter {
    @Autowired
    ...
    public static void main(String[] args) {
        SpringApplication.run(DemnitarServiceApplication.class, args);
    }
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2).select()
                .apis(RequestHandlerSelectors.basePackage("com.declaratiiavere.demnitarservice"))
